 ...
 * contiene las funciones y atributos necesarios para la comunicacion con el Servidor MQTT
 *
        ...
        public void addNewSubscription(Subscription subscription) throws MqttException {
            if(!subscriptions.containsKey(subscription.getTopic())){
                try{
                    ...
                    /*final WifiP2pManager.ActionListener callback = new WifiP2pManager.ActionListener(this.context,
                            WifiP2pManager.ActionListener.Action.SUBSCRIBE, this, actionArgs);
